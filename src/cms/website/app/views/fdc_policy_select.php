...
function OnQuery(){
	url ="/fdc/PolicySearch?name="+document.all.name.value;
	...
	document.all.ResultFrame.src=url;
...
<table width="100%" border="1" cellspacing="2" cellpadding="1">
  ...
  <tr>
    <td colspan="2"><input type="button" name="Submit3" value="搜索" onClick="OnQuery()"></td>
  </tr>
 
</table>
<iframe name='ResultFrame' src="#" width="100%" height="100%">
	</iframe>	
</body>
</html>
